...
# Libraries: 
Install required packages using:pip install gspread oauth2client cohere pandas matplotlib google-api-python-client google-auth-httplib2 google-auth-oauthlib
